...
#SBATCH --error=logs/problem2_%j.log
...
RUN="apptainer exec /data/courses/2026_dat471_dit066/containers/assignment5.sif python3 assignment5_problem2_skeleton.py --num-registers 128"
