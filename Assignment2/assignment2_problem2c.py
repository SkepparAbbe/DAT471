...
if __name__ == '__main__':
    ...
    print(f"Block 1 time: {t_block1}")
    print(f"Block 2 time: {t_block2}")
    print(f"Block 3 time: {t_block3}")
    print(f"Block 4 time: {t_block4}")
    print(f"Sequential time: {t_s}")
    print(f"Parallel time: {t_p}")
    print(f"Parallel fraction: {t_p / t_tot}")
